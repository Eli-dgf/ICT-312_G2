...
<html lang="en">
  ...
  <body style="background: #F0F2F0;background: -webkit-linear-gradient(to bottom, #006400, #F0F2F0);background: linear-gradient(to bottom, #006400, #F0F2F0); background-size: cover;">

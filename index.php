...
/* Added styles for navbar and footer */
.navbar {
...
/* Maintain the welcome image animation */
.register-left img {
    margin-top: 15%;
    margin-bottom: 5%;
    width: 25%;
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;">
        <img src="images/favicon.png" alt="HMS Logo">
        <h4><i class="fa fa-hospital-o" aria-hidden="true"></i>&nbsp HOSPITAL MANAGEMENT SYSTEM</h4>
      </a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="images/favicon.png" alt="Hospital Logo"/>
                        <h3>Simple & Seamless Booking</h3>
                    </div>
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="index1.php">Already have an account? Login Here</a>
                                        </div>
                                    </div>
    ...
    <footer class="footer">
        <div class="footer-content">
            <img src="images/favicon.png" alt="HMS Logo">
            <p class="m-0">&copy; 2025 Hospital Management System. All rights reserved.</p>
        </div>
    </footer>
